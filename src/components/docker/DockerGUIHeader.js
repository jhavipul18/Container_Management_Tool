...
const DockerGUIHeader = () => {
    return (
        ...
        >
            <ButtonNormal text="List all containers" cmd="docker ps -a" />
            <ButtonNormal text="List running containers" cmd="docker ps" />
            <ButtonNormal text="List stopped containers" cmd="echo ... " />
            <ButtonNormal text="List images" cmd="docker images" />
            <ButtonNormal text="List networks" cmd="docker network ls" />
            
            <ButtonWithSingleInput text="Show container log" label="Container id/name" cmd="docker logs " />
            <ButtonWithSingleInput text="Pull docker image" label="Image name" cmd="docker pull " />
